...
if not TELEGRAM_BOT_TOKEN:
    print("=" * 80)
    print("❌ ERROR: TELEGRAM_BOT_TOKEN_TEST not found in environment variables!")
    print("=" * 80)
    print("")
    print("Please set the following environment variable:")
    print("")
    print("  TELEGRAM_BOT_TOKEN_TEST=your_test_bot_token_here")
    print("")
    print("Get your test bot token from: https://t.me/BotFather")
    print("")
    print("See env_template.txt for full list of required variables.")
    print("=" * 80)
    raise ValueError("TELEGRAM_BOT_TOKEN_TEST environment variable is required")

print(f"✅ Bot token found: {TELEGRAM_BOT_TOKEN[:10]}...")
print("🧪 TEST BOT MODE - Running test bot instance")
ensure_dirs()
...
async def cmd_start(m: Message):
    ...
    await m.answer(
        "🧪 <b>ТЕСТОВЫЙ БОТ - Datanauts.io</b>\n\n"
        "🎬 <b>Добро пожаловать в тестовую версию сервиса!</b>\n\n"
        ...
        "⚠️ <b>Внимание:</b> Это тестовая версия для разработки.\n\n"
        "Выберите действие:",
        parse_mode="HTML",
